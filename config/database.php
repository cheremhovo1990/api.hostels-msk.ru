...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'parse' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_PARSE', '127.0.0.1'),
            'port' => env('DB_PORT_PARSE', '3306'),
            'database' => env('DB_DATABASE_PARSE', 'forge'),
            'username' => env('DB_USERNAME_PARSE', 'forge'),
            'password' => env('DB_PASSWORD_PARSE', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
